...
public class EKGDataPacket {
    ...
    public EKGDataPacket(int sequence, byte[] data) {
        ...
        this.lCh2 = new SimpleStringProperty(byteToString(data[2]));
        this.lCh3 = new SimpleStringProperty(byteToString(data[3]));
        this.lCh4 = new SimpleStringProperty(byteToString(data[4]));
        this.lCh5 = new SimpleStringProperty(byteToString(data[5]));
        this.lCh6 = new SimpleStringProperty(byteToString(data[6]));
        this.lCh7 = new SimpleStringProperty(byteToString(data[7]));
        this.lCh8 = new SimpleStringProperty(byteToString(data[8]));
        this.lCh9 = new SimpleStringProperty(byteToString(data[9]));
        this.lCh10 = new SimpleStringProperty(byteToString(data[10]));
        this.lCh11 = new SimpleStringProperty(byteToString(data[11]));
        this.lCh12 = new SimpleStringProperty(byteToString(data[12]));
        this.lCh13 = new SimpleStringProperty(byteToString(data[13]));
        this.lCh14 = new SimpleStringProperty(byteToString(data[14]));

        this.rEmg = new SimpleStringProperty(byteToString(data[15]));
        this.rCh1 = new SimpleStringProperty(byteToString(data[16]));
        this.rCh2 = new SimpleStringProperty(byteToString(data[17]));
        this.rCh3 = new SimpleStringProperty(byteToString(data[18]));
        this.rCh4 = new SimpleStringProperty(byteToString(data[19]));
        this.rCh5 = new SimpleStringProperty(byteToString(data[20]));
        this.rCh6 = new SimpleStringProperty(byteToString(data[21]));
        this.rCh7 = new SimpleStringProperty(byteToString(data[22]));
        this.rCh8 = new SimpleStringProperty(byteToString(data[23]));
        this.rCh9 = new SimpleStringProperty(byteToString(data[24]));
        this.rCh10 = new SimpleStringProperty(byteToString(data[25]));
        this.rCh11 = new SimpleStringProperty(byteToString(data[26]));
        this.rCh12 = new SimpleStringProperty(byteToString(data[27]));
        this.rCh13 = new SimpleStringProperty(byteToString(data[28]));
        this.rCh14 = new SimpleStringProperty(byteToString(data[29]));
